...
BOOT_MARKERS = (
    ...
    b"NETWORK_DEVICE_BOUNDARY_ONLINE",
    b"NIC_QUARANTINED",
    b"VIRTIO_NET_TRANSPORT_VALID",
    b"RUST_NETWORK_CORE_ONLINE",
    b"PACKET_PARSER_NEGATIVE_TESTS_PASS",
    b"BOUNDED_PACKET_QUEUES_PASS",
    b"TCP_STATE_CORE_PASS",
    b"NETWORK_EGRESS_DISABLED",
    b"AHCI_SATA_ONLINE",
    ...
    b"APIC_TIMER_TICK",
    b"USER_PROCESS_STARTED",
    b"USER_PROCESS_RESUMED",
    b"USER_RING3_ONLINE",
    ...
    b"CAPABILITY_HANDLES_PASS",
    b"BOUNDED_IPC_PASS",
    b"ANONYMITY_FAIL_CLOSED_PASS",
...
SHELL_PROBES = (
    ...
    (b"security\r", b"SECURITY_POLICY_OK"),
    (b"network\r", b"NETWORK_FOUNDATION_OK"),
...
def qemu_command(
    ...
    command = [
        ...
        "std",
        "-netdev",
        "hubport,id=argus_isolated_a,hubid=0",
        "-netdev",
        "hubport,id=argus_isolated_b,hubid=0",
        "-device",
        "virtio-net-pci,disable-legacy=on,netdev=argus_isolated_a,"
        "mac=52:54:00:41:52:47,romfile=",
        "-device",
        "e1000e,netdev=argus_isolated_b,mac=52:54:00:41:52:48,romfile=",
        "-no-reboot",
        "-monitor",
        "none",
        "-nodefaults",
